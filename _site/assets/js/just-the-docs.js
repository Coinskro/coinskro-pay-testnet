...
function initSearch() {
  ...
  request.open('GET', '/coinskro-pay-testnet/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/coinskro-pay-testnet/assets/css/just-the-docs-' + theme + '.css');
}
